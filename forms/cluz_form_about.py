...
class Ui_aboutDialog(object):
    def setupUi(self, aboutDialog):
        ...
        aboutDialog.resize(650, 260)
        aboutDialog.setMinimumSize(QtCore.QSize(650, 260))
        ...
        self.iconLogo.setPixmap(QtGui.QPixmap(":/logos/images/cluz_logo.png"))
        ...
        self.pushButton.clicked.connect(aboutDialog.close) # type: ignore
    ...
    def retranslateUi(self, aboutDialog):
        ...
        self.fundedLabel.setText(_translate("aboutDialog", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Supported  by</span><span style=\" font-size:10pt;\">: </span><a href=\"https://www.ukri.org/what-we-do/browse-our-areas-of-investment-and-support/expanding-excellence-in-england-e3-fund/\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">UKRI Research England\'s Expanding Excellence in England (E3) fund</span></a></p></body></html>"))
        self.codeLabel.setText(_translate("aboutDialog", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Code</span><span style=\" font-size:10pt;\">: </span><a href=\"https://github.com/CLUZ-systematic-conservation-planning/CLUZ\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">https://github.com/CLUZ-systematic-conservation-planning/CLUZ</span></a></p></body></html>"))
        self.websiteLLabel.setText(_translate("aboutDialog", "<html><head/><body><p><span style=\" font-size:10pt; font-weight:600;\">Website</span><span style=\" font-size:10pt;\">: </span><a href=\"https://cluz-systematic-conservation-planning.github.io/\"><span style=\" font-size:10pt; text-decoration: underline; color:#0000ff;\">https://cluz-systematic-conservation-planning.github.io</span></a></p></body></html>"))
